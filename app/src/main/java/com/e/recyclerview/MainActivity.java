...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presidentList.add(new President("Donald Trump","God   father",R.drawable.ic_launcher_background));
        presidentList.add(new President("George H. W. Bush","dfkdls",R.drawable.ic_launcher_background));
